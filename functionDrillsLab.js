...
//CODE HERE
function theEliminator(contestantsNames, loser){
  for(i = 0; i < contestantsNames.length; i++){
    if(contestantsNames[i] === loser){
      contestantsNames.splice(i, 1)
    }
  }
  return contestantsNames
}
var winners = theEliminator(contestants, loser);
console.log(winners)
...
makeItBig("check 1 2 i am not lower case anymore")
...
totalFrogs = chocolateFrogs(175)
console.log(`You can afford ${totalFrogs} chocolate frogs`)
////////////////// PROBLEM 13 ////////////////////
/*
...
//CODE HERE
function chocolateFrogs2(goldSpent2){
  frogs = goldSpent2 / 3;
  frogs = Math.floor(frogs);
  return frogs;
}
totalFrogs2 = chocolateFrogs2(157)
console.log(`You can afford ${totalFrogs2} chocolate frogs`)
...
function takeArray(array1){
  let comparison = array1[0]
  for(let i = 1; i < array1.length - 1; i++){
    if(array1[i] <= comparison){
...
let arrayIsAscending = takeArray(sampleArray)
